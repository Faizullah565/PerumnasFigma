...
const Features2 = () => {
  return (
    <div className="features-section2-container">
        <img src="/feature-section2.jpg" alt="Feature Section-2-image" className='feature-section2-image' />
        <div className="feature-section2-content">
            <h3 className='feature-section2-heading1'>Strategic Location</h3>
